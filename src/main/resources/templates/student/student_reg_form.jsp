...
<head>
	...
	<!-- Font-->
	<link rel="stylesheet" type="text/css" th:href="@{../student_reg_form/css/opensans-font.css">
	<link rel="stylesheet" type="text/css" th:href="@{../student_reg_form/css/roboto-font.css">
	<link rel="stylesheet" type="text/css"
		th:href="@{../student_reg_form/fonts/material-design-iconic-font/css/material-design-iconic-font.min.css">
	<!-- datepicker -->
	<link rel="stylesheet" type="text/css" th:href="@{../student_reg_form/css/jquery-ui.min.css">
	<!-- Main Style Css -->
	<link rel="stylesheet" th:href="@{../student_reg_form/css/style.css" />
</head>
...
<body>
	...
	<script th:src="@{../student_reg_form/js/jquery-3.3.1.min.js"></script>
	<script th:src="@{../student_reg_form/js/jquery.steps.js"></script>
	<script th:src="@{../student_reg_form/js/jquery-ui.min.js"></script>
	<script th:src="@{../student_reg_form/js/main.js"></script>
</body>
