...
<title>Jeewa Education</title>
	...
	<!-- Font-->
	<link rel="stylesheet" type="text/css" th:href="@{../payment/forms/css/opensans-font.css">
	<link rel="stylesheet" type="text/css" th:href="@{../payment/forms/css/roboto-font.css">
	<link rel="stylesheet" type="text/css" th:href="@{../payment/forms/fonts/material-design-iconic-font/css/material-design-iconic-font.min.css">
	<!-- datepicker -->
	<link rel="stylesheet" type="text/css" th:href="@{../payment/forms/css/jquery-ui.min.css">
	<!-- Main Style Css -->
    <link rel="stylesheet" type="text/css" th:href="@{../payment/forms/css/style.css">
	<!-- table and file uploader -->
	<link rel="stylesheet" type="text/css" th:href="@{../payment/forms/css/table.css"/>
</head>
<body>
		...
		<div class="wizard-v4-content">
			<div class="wizard-form">
				<div class="wizard-header">
					<h3 class="heading">Payment Form For VISA Applicants</h3>	
				</div>
								...
								<div class="form-row">
									<div class="form-holder form-holder-1">
										<label class="form-row-inner">
											...
											<span class="label">Full Name of the Applicant</span>
	...
	<script th:src="@{../payment/forms/js/jquery-3.3.1.min.js"></script>
	<script th:src="@{../payment/forms/js/jquery.steps.js"></script>
	<script th:src="@{../payment/forms/js/jquery-ui.min.js"></script>
	<script th:src="@{../payment/forms/js/main.js"></script>
	<script th:src="@{../payment/forms/js/script.js"></script>
</body>
</html>